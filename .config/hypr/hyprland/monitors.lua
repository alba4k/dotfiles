...
local function applyLayout()
    ...
    --hl.exec_cmd("notify-send -t 2000 -a Sistema -i display -u low -h boolean:transient:true -h string:synchronous:DISPLAY 'Configurazione Schermi' 'Posizione schermi modificata'")
